...
- Companion App: The timeline generator app requires Python installed on your system. This app can be found on [GitHub](https://github.com/sirbilby/fastplace-sync-app).